...
class _CitySelectPageState extends State<CitySelectPage> {
  ...
  void loadData() async {
    ...
    rootBundle.loadString('assets/data/china.json').then((value) {
      ...
      _hotCityList.add(CityInfo(name: "北京", tagIndex: "热门"));
      _hotCityList.add(CityInfo(name: "广州", tagIndex: "热门"));
      _hotCityList.add(CityInfo(name: "成都", tagIndex: "热门"));
      _hotCityList.add(CityInfo(name: "深圳", tagIndex: "热门"));
      _hotCityList.add(CityInfo(name: "杭州", tagIndex: "热门"));
      _hotCityList.add(CityInfo(name: "武汉", tagIndex: "热门"));
